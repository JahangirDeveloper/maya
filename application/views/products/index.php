    ...
    <div class="row">
        <?php if(!empty($products)): foreach($products as $product): ?>
          <div class="col-lg-4 thumbnail">
            <img src="<?php echo base_url().'uploads/books/'.$product['image']; ?>" alt="">
            <div class="caption">
                <h4 class="pull-right">$<?php echo $product['price']; ?></h4>
                <h4><a href="javascript:void(0);"><?php echo $product['name']; ?></a></h4>
            </div>
            <a href="<?php echo base_url().'Products/buyProduct/'.$product['id']; ?>"><img src="<?php echo base_url(); ?>assets/img/buy_now+with_paypal.png"></a>
          </div>
