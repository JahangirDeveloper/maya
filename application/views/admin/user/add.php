  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><?php echo $this->lang->line('Add_User');?></h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url().'admin/';?>"><?php echo $this->lang->line('Home'); ?></a></li>
              <li class="breadcrumb-item"><a href="<?php echo base_url().'admin/users'; ?>"><?php echo $this->lang->line('Users'); ?></a></li>
              <li class="breadcrumb-item"><a href="#!"><?php echo $this->lang->line('Add_User');?></a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <!-- Start: FlashMsg -->
              <?php if($this->session->flashdata('status')!=''){ ?>
                <div class="alert alert-dismissible <?php if($this->session->flashdata('alert_type')!=''){ echo $this->session->flashdata('alert_type'); }?>">
                    ...
                    <?php if($this->session->flashdata('alert_msg')!='') { echo $this->session->flashdata('alert_msg'); } ?></div>
              <?php } ?>
            <!-- End: FlashMsg -->
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><?php echo $this->lang->line('Add_User'); ?></h3>
              </div>
              <!-- /.card-header -->
              <form action='<?php echo base_url()."admin/user/add/"; ?>' enctype="multipart/form-data" class="" method="post" accept-charset="utf-8">
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group ">
                          ...
                          <select class="form-control <?php if(form_error('role_id')){ echo 'border-danger';} ?>" name="role_id" id="role_id">
                            ...
                            <?php foreach ($roles as $key => $value) { ?>
                              <option <?php if(set_value('role_id') == $value['id']){ echo 'selected';} ?> value="<?php echo $value['id'];?>"><?php echo $value['title'];?></option>
                            <?php } ?>
                          </select>
                        </div>
                  ...
                  <div class="row">
                      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control <?php if(form_error('first_name')){ echo 'border-danger';} ?>" name="first_name" id="first_name" placeholder="" value="<?php echo set_value('first_name'); ?>">
                        </div>
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control <?php if(form_error('middle_name')){ echo 'border-danger';} ?>" name="middle_name" id="middle_name" placeholder="" value="<?php echo set_value('middle_name'); ?>">
                        </div>
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control <?php if(form_error('last_name')){ echo 'border-danger';} ?>" name="last_name" id="last_name" placeholder="" value="<?php echo set_value('last_name'); ?>">
                        </div>
                    ...
                    <div class="row d-none">
                      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="form-group">
                          ...
                          <textarea class="form-control <?php if(form_error('short_desc_en')){ echo 'border-danger';} ?>" name="short_desc_en" id="short_desc_en"><?php echo set_value('short_desc_en'); ?></textarea>
                        </div>
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="form-group">
                          ...
                          <textarea class="form-control <?php if(form_error('short_desc_ar')){ echo 'border-danger';} ?>" name="short_desc_ar" id="short_desc_ar"><?php echo set_value('short_desc_ar'); ?></textarea>
                        </div>
                    ...
                    <div class="row">
                      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="form-group ">
                          ...
                          <select class="form-control <?php if(form_error('gender')){ echo 'border-danger';} ?>" name="gender" id="gender">
                            <option value=""><?php echo $this->lang->line('Choose'); ?></option>
                            <option <?php if(set_value('gender') == '1'){ echo 'selected';} ?> value="1"><?php echo $this->lang->line('Male'); ?></option>
                            <option <?php if(set_value('gender') == '2'){ echo 'selected';} ?> value="2"><?php echo $this->lang->line('Female'); ?></option>
                            </select>
                        </div>
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="form-group ">
                          ...
                          <input type="text" class="form-control <?php if(form_error('contact_nmbr')){ echo 'border-danger';} ?>" name="contact_nmbr" id="contact_nmbr" placeholder="" value="<?php echo set_value('contact_nmbr'); ?>">
                        </div>
                    ...
                    <div class="row d-none">
                      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group ">
                          ...
                          <input type="text" class="form-control <?php if(form_error('whatsapp')){ echo 'border-danger';} ?>" name="whatsapp" id="whatsapp" placeholder="" value="<?php echo set_value('whatsapp'); ?>">
                        </div>
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control <?php if(form_error('instagram')){ echo 'border-danger';} ?>" name="instagram" id="instagram" placeholder="" value="<?php echo set_value('instagram'); ?>">
                        </div>
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control <?php if(form_error('facebook')){ echo 'border-danger';} ?>" name="facebook" id="facebook" placeholder="" value="<?php echo set_value('facebook'); ?>">
                        </div>
                    ...
                    <div class="row d-none">
                      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group ">
                          ...
                          <input type="text" class="form-control <?php if(form_error('twitter')){ echo 'border-danger';} ?>" name="twitter" id="twitter" placeholder="" value="<?php echo set_value('twitter'); ?>">
                        </div>
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control <?php if(form_error('google_plus')){ echo 'border-danger';} ?>" name="google_plus" id="google_plus" placeholder="" value="<?php echo set_value('google_plus'); ?>">
                        </div>
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control <?php if(form_error('snapchat')){ echo 'border-danger';} ?>" name="snapchat" id="snapchat" placeholder="" value="<?php echo set_value('snapchat'); ?>">
                        </div>
                    ...
                    <div class="row d-none">
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                          ...
                          <textarea class="form-control <?php if(form_error('address')){ echo 'border-danger';} ?>" name="address" id="address"><?php echo set_value('address'); ?></textarea>
                        </div>
                        ...
                        <div class="form-group ">
                          ...
                          <select class="form-control <?php if(form_error('city_id')){ echo 'border-danger';} ?>" name="city_id" id="city_id">
                            ...
                            <?php foreach ($cities as $key => $value) { ?>
                              <option <?php if(set_value('city_id') == $value['id']){ echo 'selected';} ?> value="<?php echo $value['id'];?>"><?php echo $value['title'];?></option>
                            <?php } ?>
                          </select>
                        </div>
                        ...
                        <div class="form-group ">
                          ...
                          <select class="form-control <?php if(form_error('area_id')){ echo 'border-danger';} ?>" name="area_id" id="area_id">
                            ...
                            <?php foreach ($areas as $key => $value) { ?>
                              <option <?php if(set_value('area_id') == $value['id']){ echo 'selected';} ?> value="<?php echo $value['id'];?>"><?php echo $value['title'];?></option>
                            <?php } ?>
                          </select>
                        </div>
                    ...
                    <div class="row d-none">
                      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group ">
                          ...
                          <select class="form-control <?php if(form_error('is_payment_allowed')){ echo 'border-danger';} ?>" name="is_payment_allowed" id="is_payment_allowed">
                            <option value=""><?php echo $this->lang->line('Choose'); ?></option>
                            <option <?php if(set_value('is_payment_allowed') == '1'){ echo 'selected';} ?> value="1"><?php echo $this->lang->line('YES'); ?></option>
                            <option <?php if(set_value('is_payment_allowed') == '0'){ echo 'selected';} ?> value="0"><?php echo $this->lang->line('NO'); ?></option>
                          </select>
                        </div>
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group">
                          ...
                          <select class="form-control <?php if(form_error('is_registration_social')){ echo 'border-danger';} ?>" name="is_registration_social" id="is_registration_social">
                            <option value=""><?php echo $this->lang->line('Choose'); ?></option>
                            <option <?php if(set_value('is_registration_social') == '1'){ echo 'selected';} ?> value="1"><?php echo $this->lang->line('YES'); ?></option>
                            <option <?php if(set_value('is_registration_social') == '0'){ echo 'selected';} ?> value="0"><?php echo $this->lang->line('NO'); ?></option>
                          </select>
                        </div>
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="form-group">
                          ...
                          <input readonly disabled type="text" class="form-control" name="email" id="email" placeholder="" value="<?php echo set_value('email'); ?>">
                        </div>
                    ...
                    <div class="row">
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="text-left">
                          <img class="profile-user-img img-fluid img-circle" src="<?php echo base_url().'uploads/no_user_image.png'; ?>" alt="">
                        </div>
