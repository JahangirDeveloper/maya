        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="#!"><?php echo $this->lang->line('btn_add'); ?></a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                 ...
                 <form action='<?php echo base_url()."admin/city/add/".$state_id_encoded; ?>' enctype="multipart/form-data" class="" method="post" accept-charset="utf-8">
                  <div class="card-body ">
                    <div class="form-group">
                      <label for="parent_id"><?php echo $this->lang->line('Country'); ?></label>
                    ...
                    <div class="form-group">
                      <label for="parent_id"><?php echo $this->lang->line('City'); ?></label>
