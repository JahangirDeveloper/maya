                        ...
                        <td>
                          <div class="btn-group">
                            ...
                            <div class="dropdown-menu" role="menu">
                              <a class="dropdown-item text-primary" href="<?php echo base_url().'admin/Slider/edit/'.base64_encode($value['id']).'/'.$type; ?>"><?php echo $this->lang->line('btn_edit'); ?> <i class="fa fa-edit float-right"></i></a>
