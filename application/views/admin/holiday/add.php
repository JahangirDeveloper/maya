        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <form action='<?php echo base_url()."admin/holiday/add/"; ?>' enctype="multipart/form-data" class="" method="post" accept-charset="utf-8">
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="url" id="url" placeholder="" value="<?php echo set_value('url'); ?>">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input autocomplete="off" id="start_date" type="text" class="form-control"  name="start_date" value="<?php echo set_value('start_date'); ?>"/>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input autocomplete="off" id="end_date" type="text" class="form-control"  name="end_date" value="<?php echo set_value('end_date'); ?>"/>
