        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="#!"><?php echo $this->lang->line('Team'); ?></a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <?php if($this->session->flashdata('status')!=''){ ?>
              ...
              <div class="card">
                <div class="card-header">
                  <div class="row">
                    <div class="col-lg-6">
                      <h3 class="card-title"><?php echo $this->lang->line('Team'); ?></h3>
                    </div>
                    <div class="col-lg-6 text-right">
                      <a href="<?php echo base_url().'admin/Team/add'; ?>" class="nav-link text-uppercase p-0">
                        <?php echo $this->lang->line('add_Team_Member'); ?>
                      </a>
                    </div>
                  </div>
                </div>
                      ...
                      <tr class="text-center">
                        ...
                        <td class="text-center">
                          <div class="w_h_150 ml-auto mr-auto">
                            <?php if($value['image'] != ''){ ?>
                            <img class="img-fluid w-100 box-shadow"  src="<?php echo base_url().'uploads/team/'.$value['image']; ?>" alt="">
                            <?php } else { ?>
                        ...
                        <td>
                          <div class="btn-group">
                            ...
                            <div class="dropdown-menu" role="menu">
                              <a class="dropdown-item" href="<?php echo base_url().'admin/Team/edit/'.base64_encode($value['id']); ?>"><?php echo $this->lang->line('btn_edit'); ?></a>
                              <div class="dropdown-divider"></div>
                              <a class="dropdown-item btn_delete text-danger" tbl="<?php echo base64_encode('team_tbl'); ?>" row="<?php echo base64_encode($value['id']); ?>" href="#!"><?php echo $this->lang->line('btn_delete'); ?> <i class="fa fa-trash float-right"></i></a>
                            </div>
                          </div>
                        </td>
                      </tr>
