  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><?php echo $this->lang->line('add_Team_Member'); ?></h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="#!"><?php echo $this->lang->line('add_Team_Member'); ?></a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <!-- End: FlashMsg -->
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title"><?php echo $this->lang->line('add_Team_Member'); ?></h3>
                </div>
                <!-- /.card-header -->
                 <form action='<?php echo base_url()."admin/Team/add/"; ?>' enctype="multipart/form-data" class="" method="post" accept-charset="utf-8">
                  <div class="card-body ">
                    <div class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                          <div class="form-group">
                            <label for="title_en"><?php echo $this->lang->line('designation'); ?></label>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="twitter" id="twitter" placeholder="TYPE HERE" value="<?php echo set_value('twitter'); ?>">
                        ...
                        <div class="col-lg-12">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="facebook" id="facebook" placeholder="TYPE HERE" value="<?php echo set_value('twitter'); ?>">
                        ...
                        <div class="col-lg-12">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="instagram" id="instagram" placeholder="TYPE HERE" value="<?php echo set_value('twitter'); ?>">
                        ...
                        <div class="col-lg-12">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="linkedin" id="linkedin" placeholder="TYPE HERE" value="<?php echo set_value('twitter'); ?>">
