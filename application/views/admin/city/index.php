                ...
                <div class="card-header">
                  <div class="row">
                    ...
                    <div class="col-lg-6 text-right">
                      <a href="<?php echo base_url().'admin/city/add'; ?>" class="nav-link text-uppercase p-0">
                        ADD CITY
                      </a>
                    </div>
                  </div>
                        ...
                        <td>
                          <div class="btn-group">
                            ...
                            <div class="dropdown-menu" role="menu">
                              <a class="dropdown-item" href="<?php echo base_url().'admin/city/edit/'.base64_encode($value['id']); ?>">EDIT</a>
                              <a class="dropdown-item" href="<?php echo base_url().'admin/area/add/'.base64_encode($value['id']); ?>">ADD AREA</a>
