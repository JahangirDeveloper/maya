          ...
          <div class="col-12">
            ...
            <!-- End: FlashMsg -->
              <div class="card">
                ...
                <!-- /.card-header -->
                 <form action='<?php echo base_url()."admin/city/edit/".$city_id_decoded; ?>' enctype="multipart/form-data" class="" method="post" accept-charset="utf-8">
                  <div class="card-body ">
                    ...
                    <div class="form-group">
                      ...
                      <select class="custom-select" name="country_id" id="country_id">
                        <?php foreach ($countries as $key => $countryDetail) { ?>
                          <option <?php if($cityDetails['country_id'] == $countryDetail['id']){ echo 'selected';} ?> value="<?php echo $countryDetail['id'];?>"><?php echo $countryDetail['title'];?></option>
                        <?php } ?>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <select class="custom-select" name="state_id" id="state_id">
                        <?php foreach ($states as $key => $stateDetail) { ?>
                          <option <?php if($cityDetails['state_id'] == $stateDetail['id']){ echo 'selected';} ?> value="<?php echo $stateDetail['id'];?>"><?php echo $stateDetail['title'];?></option>
                        <?php } ?>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="title_en" id="title_en" placeholder="TYPE HERE" value="<?php echo $cityDetails['title_en']; ?>">
                    </div>

                    <div class="form-group">
                      <label for="title_en">NAME (ARABIC)</label>
                      <input type="text" class="form-control" name="title_ar" id="title_ar" placeholder="TYPE HERE" value="<?php echo $cityDetails['title_ar']; ?>">
                    </div>
