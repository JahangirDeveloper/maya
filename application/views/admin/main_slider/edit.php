        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url().'admin/Main_slider'; ?>"><?php echo $this->lang->line('Slides'); ?></a></li>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
                <form action="<?php echo base_url().'admin/Main_slider/edit/'.$media_id_encoded.'/'.$type; ?>" enctype="multipart/form-data" class="" method="post" accept-charset="utf-8">
                  <div class="card-body ">
                    <div class="row">
                        <div class="col-lg-6">
