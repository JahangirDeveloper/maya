        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="#!"><?php echo $this->lang->line('Edit_User_Role'); ?></a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <!-- End: FlashMsg -->
              <div class="card">
                ...
                <!-- /.card-header -->
                 <form action='<?php echo base_url()."admin/user_role/edit/".$user_role_id; ?>' enctype="multipart/form-data" class="" method="post" accept-charset="utf-8">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                          <label for="title_en"><?php echo $this->lang->line('Title_EN'); ?></label>
                          <input autocomplete="off" id="title_en" type="text" class="form-control input_edit" tbl="<?php echo base64_encode('user_role_tbl') ?>" col="<?php echo base64_encode('title_en') ?>" row="<?php echo base64_encode($userRoleDetails['id']) ?>"  name="title_en" value="<?php echo $userRoleDetails['title_en']; ?>"/>
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                          ...
                          <input autocomplete="off" id="title_ar" type="text" class="form-control input_edit" tbl="<?php echo base64_encode('user_role_tbl') ?>" col="<?php echo base64_encode('title_ar') ?>" row="<?php echo base64_encode($userRoleDetails['id']) ?>"  name="title_ar" value="<?php echo $userRoleDetails['title_ar']; ?>"/>
                          <?php echo form_error('title_ar'); ?>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <?php foreach ($permissions as $permissionsKey => $permission) { ?>
                              <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">

                                <div class="form-group clearfix">
                                  <div class="icheck-success d-inline">
                                    <input <?php if(in_array($permission['id'], $selectedPermissions)){echo "checked";} ?> type="checkbox" id="<?php echo 'checkboxPermission'.$permission['id']; ?>" class="permission_checkbox" permission_id="<?php echo $permission['id'];?>" permission_name="<?php echo $permission['title'];?>" user_role_id='<?php echo $userRoleDetails['id'];?>' user_role_name='<?php echo $userRoleDetails['title_en'];?>'>
