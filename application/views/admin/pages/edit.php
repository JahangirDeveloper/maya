  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><?php echo $this->lang->line('Edit_Page'); ?></h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="#!"><?php echo $this->lang->line('Edit_Page'); ?></a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <!-- End: FlashMsg -->
              <div class="card">
                ...
                <!-- /.card-header -->
                 <form action='<?php echo base_url()."admin/Pages/edit/".$page_id_encoded; ?>' enctype="multipart/form-data" class="" method="post" accept-charset="utf-8">
                  <div class="card-body ">
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <select class="form-control" name="category_id" id="category_id">
                            ...
                            <?php foreach ($categories as $key => $value) { ?>
                              <option <?php if($pageDetails['category_id'] == $value['id']){ echo 'selected';} ?> value="<?php echo $value['id'];?>"><?php echo $value['title'];?></option>
                            <?php } ?>
                            </select>
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="link" id="link" placeholder="TYPE HERE" value="<?php echo $pageDetails['link']; ?>">
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <select class="form-control" name="status" id="status">
                            <option value=""><?php echo $this->lang->line('Choose'); ?></option>
                            <option <?php if($pageDetails['status'] == 'Draft'){ echo 'selected';} ?> value="Draft"><?php echo $this->lang->line('Draft'); ?></option>
                            <option <?php if($pageDetails['status'] == 'Publish'){ echo 'selected';} ?> value="Publish"><?php echo $this->lang->line('Publish'); ?></option>
                          </select>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title_en" id="title_en" placeholder="TYPE HERE" value="<?php echo $pageDetails['title_en']; ?>">
                        ...
                        <div class="col-lg-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title_ar" id="title_ar" placeholder="TYPE HERE" value="<?php echo $pageDetails['title_ar']; ?>">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                          <div class="form-group">
                            ...
                            <textarea class="form-control" name="short_desc_en" id="short_desc_en" placeholder="TYPE HERE"><?php echo $pageDetails['short_desc_en']; ?></textarea>
                        ...
                        <div class="col-lg-6">
                          <div class="form-group">
                            ...
                            <textarea class="form-control" name="short_desc_ar" id="short_desc_ar" placeholder="TYPE HERE"><?php echo $pageDetails['short_desc_ar']; ?></textarea>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                          <div class="form-group">
                            ...
                            <textarea class="form-control" name="long_desc_en" id="long_desc_en" placeholder="TYPE HERE"><?php echo $pageDetails['long_desc_en']; ?></textarea>
                        ...
                        <div class="col-lg-6">
                          <div class="form-group">
                            ...
                            <textarea class="form-control" name="long_desc_ar" id="long_desc_ar" placeholder="TYPE HERE"><?php echo $pageDetails['long_desc_ar']; ?></textarea>
                    ...
                    <div class="row">
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="text-left" style="width: 150px;height: 150px;">
                          <?php if($pageDetails['image'] != ''){ ?>
                          <img class="img-fluid w-100" src="<?php echo base_url().'uploads/page/'.$pageDetails['image']; ?>" alt="">
                          <?php } else { ?>
