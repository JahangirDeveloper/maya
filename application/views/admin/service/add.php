  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><?php echo $this->lang->line('Add_Service'); ?></h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="#!"><?php echo $this->lang->line('Add_Service'); ?></a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <!-- End: FlashMsg -->
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title"><?php echo $this->lang->line('Add_Service'); ?></h3>
                </div>
                <!-- /.card-header -->
                 <form action='<?php echo base_url()."admin/Service/add/"; ?>' enctype="multipart/form-data" class="" method="post" accept-charset="utf-8">
                  <div class="card-body ">
                    <div class="row">
                        <div class="col-lg-6">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        ...
                        <div class="text-red"><?php if(isset($icon_error)){echo $icon_error;} ?></div>
                      </div>
