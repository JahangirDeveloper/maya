  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><?php echo $this->lang->line('Edit_Portfolio'); ?></h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url().'admin/';?>"><?php echo $this->lang->line('Home'); ?></a></li>
              <li class="breadcrumb-item"><a href="<?php echo base_url().'admin/Portfolio'; ?>"><?php echo $this->lang->line('Portfolios'); ?></a></li>
              <li class="breadcrumb-item"><a href="#!"><?php echo $this->lang->line('Edit_Portfolio'); ?></a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><?php echo $this->lang->line('Edit_Portfolio'); ?></h3>
              </div>
              <!-- /.card-header -->
              <form action='<?php echo base_url()."admin/Portfolio/edit/".$portfolio_id_encoded; ?>' enctype="multipart/form-data" class="" method="post" accept-charset="utf-8">
                <div class="card-body ">
                  <div class="row">
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <select name="category_id" id="category_id" class="form-control">
                            ...
                            <?php foreach ($categories as $key => $value) { ?>
                              <option <?php if($value['id'] == $PortfolioDetails['category_id']){echo 'selected';} ?> value="<?php echo $value['id']; ?>"><?php echo $value['title']; ?></option>
                            <?php } ?>
                          </select>
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="project_name" id="project_name" placeholder="<?php echo $this->lang->line('Project_Name'); ?>" value="<?php echo $PortfolioDetails['project_name']; ?>">
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <input autocomplete="off" type="text" class="form-control" name="start_date" id="start_date" placeholder="<?php echo $this->lang->line('Start_Date'); ?>" value="<?php echo $PortfolioDetails['start_date']; ?>">
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="project_desc" id="project_desc" placeholder="<?php echo $this->lang->line('Project_Desc'); ?>"><?php echo $PortfolioDetails['project_desc']; ?></textarea>
                ...
                <div class="card-footer d-block text-right">
                  <a class="btn btn-warning" href="<?php echo base_url().'admin/Slider/index/project/'.$portfolio_id_encoded; ?>">Sliders</a>
