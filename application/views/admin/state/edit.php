          ...
          <div class="col-12">
            ...
            <!-- End: FlashMsg -->
              <div class="card">
                ...
                <!-- /.card-header -->
                 <form action='<?php echo base_url()."admin/state/edit/".$State_id_decoded; ?>' enctype="multipart/form-data" class="" method="post" accept-charset="utf-8">
                  <div class="card-body">
                    
                    <div class="form-group">
                      <label for="parent_id">COUNTRY</label>
                      <select class="custom-select" name="country_id" id="country_id">
                        <?php foreach ($countries as $key => $countryDetial) { ?>
                          <option <?php if($StateDetails['country_id'] == $countryDetial['id']){ echo 'selected';} ?> value="<?php echo $countryDetial['id'];?>"><?php echo $countryDetial['title'];?></option>
                        <?php } ?>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="title_en" id="title_en" placeholder="TYPE HERE" value="<?php echo $StateDetails['title_en']; ?>">
                    </div>

                    <div class="form-group">
                      <label for="title_en">NAME (ARABIC)</label>
                      <input type="text" class="form-control" name="title_ar" id="title_ar" placeholder="TYPE HERE" value="<?php echo $StateDetails['title_ar']; ?>">
                    </div>
