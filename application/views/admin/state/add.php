        ...
        <div class="row">
          <div class="col-12">
              ...
              <div class="card">
                ...
                <!-- /.card-header -->
                 <form action='<?php echo base_url()."admin/state/add/"; ?>' enctype="multipart/form-data" class="" method="post" accept-charset="utf-8">
                  <div class="card-body ">
                    <div class="form-group">
                      <label for="parent_id">COUNTRY</label>
                      <select class="custom-select" name="country_id" id="country_id">
                        <?php foreach ($countries as $key => $value) { ?>
                          <option <?php if(set_value('country_id') == $value['id'] || $country_id == $value['id']){ echo 'selected';} ?> value="<?php echo $value['id'];?>"><?php echo $value['title'];?></option>
                        <?php } ?>
                        </select>
                    </div>
