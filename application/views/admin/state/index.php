                        ...
                        <td>
                          <div class="btn-group">
                            ...
                            <div class="dropdown-menu" role="menu">
                              <a class="dropdown-item" href="<?php echo base_url().'admin/state/edit/'.base64_encode($value['id']); ?>">EDIT</a>
                              <a class="dropdown-item" href="<?php echo base_url().'admin/city/add/'.base64_encode($value['id']); ?>">ADD CITY</a>
